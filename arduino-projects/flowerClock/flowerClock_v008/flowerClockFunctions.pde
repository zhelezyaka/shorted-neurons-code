...
*/
        	LEDs.setRow(flowerLEDs,0,random(255));
        	LEDs.setRow(flowerLEDs,1,random(255));
        	LEDs.setRow(flowerLEDs,2,random(255));
        	LEDs.setRow(flowerLEDs,3,random(255));
        	LEDs.setRow(flowerLEDs,4,random(255));
        	LEDs.setRow(flowerLEDs,5,random(255));
        	LEDs.setRow(flowerLEDs,6,random(255));
        	LEDs.setRow(flowerLEDs,7,random(255));
