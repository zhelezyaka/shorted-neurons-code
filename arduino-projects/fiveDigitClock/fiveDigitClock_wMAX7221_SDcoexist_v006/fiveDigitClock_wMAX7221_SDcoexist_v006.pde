 ...
 */
LedControl ledbar=LedControl(11,13,7,1);
...
*/
//  intToMapToOutput(dig1, hrs1);
//  intToMapToOutput(dig1, hrs2);
  intToMapToOutput(dig1, mins1);
  intToMapToOutput(dig2, mins2);
  intToMapToOutput(dig3, sec);
  intToMapToOutput(dig4, secs1);
  intToMapToOutput(dig5, secs2);
