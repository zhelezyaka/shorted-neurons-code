...
void loop()
{
  ...
  lc.setDigit(0,0,dispSign,true);
  lc.setDigit(0,1,dispSign,false);
  lc.setDigit(0,2,abs(Tf_100 / 1000 % 10),false);
  lc.setDigit(0,3,abs(Tf_100 / 100 % 10),false);
  lc.setDigit(0,4,0x8F,true);
  lc.setDigit(0,5,abs(Tf_100 /10 % 10),false);
