...
void loop()
{
  ...
  write_7seg(2,(Tf_100 / 1000));
  write_7seg(3,(Tf_100 / 100 % 10));
  write_7seg(4,0x8F);
  write_7seg(5,(Tf_100 /10 % 10));
  ...
  if (poop) {
    //str << F(" OK, shooting\n");
    Serial.print(str);
    //Serial.println(F("actually skipping shoot cuz this is expurrmental, aight?"));
    //shoot(); 
  } else {
    str << F(" too dark\n");
    Serial.print(str);
...
/* */
  ...
  //sleepWithBeacon(1);  //(60 = 86 seconds between shots)
