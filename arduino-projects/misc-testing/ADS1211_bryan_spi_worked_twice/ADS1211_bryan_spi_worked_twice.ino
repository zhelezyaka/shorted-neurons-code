...
void setup() {
  ...
  writeRegister(B00000100, B00110010);  
  ...
  writeRegister(B00000101, B00100000);  
       // write to  command reg byte 2:
         // 001 = self calibrate
         // 000 = no gain by PGA
         // 00 = channel select chan 1
  ...
  writeRegister(B00000110, B00100000);  
       // write to  command reg byte 1:
         ...
         // first five bits of "312" are : 00001

//  writeRegister(B00000111, B00111000);  
       // write to command reg byte 0
         // rest of "312" remaining 8 bits are: 00111000



  //readRegister(B10001010, 1);
...
const int NoOfSamples = 16; // Warning: if set too high, DeviationSqSum may overflow!
