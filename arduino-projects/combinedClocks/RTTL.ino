...
//char *songA = "Looney:d=4,o=5,b=140:32p,c6,8f6,8e6,8d6,8c6,a.,8c6,8f6,8e6,8d6,8d#6,e.6,8e6,8e6,8c6,8d6,8c6,8e6,8c6,8d6,8a,8c6,8g,8a#,8a,8f";
...
//char *songA = "smb:d=4,o=5,b=100:16e6,16e6,32p,8e6,16c6,8e6,8g6,8p,8g,8p,8c6,16p,8g,16p,8e,16p,8a,8b,16a#,8a,16g.,16e6,16g6,8a6,16f6,8g6,8e6,16c6,16d6,8b,16p,8c6,16p,8g,16p,8e,16p,8a,8b,16a#,8a,16g.,16e6,16g6,8a6,16f6,8g6,8e6,16c6,16d6,8b,8p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16g#,16a,16c6,16p,16a,16c6,16d6,8p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16c7,16p,16c7,16c7,p,16g6,16f#6,16f6,16d#6,16p,16e6,16p,16g#,16a,16c6,16p,16a,16c6,16d6,8p,16d#6,8p,16d6,8p,16c6";
char *songA = "smbshort:d=4,o=5,b=100:16e6,16e6,32p,8e6,16c6,8e6,8g6,8p,8g,8p";
...
//char *song3 = "SMBWater:d=8,o=6,b=225:4d5,4e5,4f#5,4g5,4a5,4a#5,b5,b5,b5,p,b5,p,2b5,p,g5,2e.,2d#.,2e.,p,g5,a5,b5,c,d,2e.,2d#,4f,2e.,2p,p,g5,2d.,2c#.,2d.,p,g5,a5,b5,c,c#,2d.,2g5,4f,2e.,2p,p,g5,2g.,2g.,2g.,4g,4a,p,g,2f.,2f.,2f.,4f,4g,p,f,2e.,4a5,4b5,4f,e,e,4e.,b5,2c.";
char *songB = "smbdeath:d=4,o=5,b=90:32c6,32c6,32c6,8p,16b,16f6,16p,16f6,16f.6,16e.6,16d6,16c6,16p,16e,16p,16c"; 
//char *song = "Wewishyoua:d=4,o=5,b=140:d,g,8g,8a,8g,8f#,e,c,e,a,8a,8b,8a,8g,f#,d,f#,b,8b,8c6,8b,8a,g,e,8d,8d,e,a,f#,2g";
//char *song2 = "Winterwond:d=4,o=5,b=112:8a#,16a#,2a#,8a#,16a#,g,2a#,8a#,16a#,2a#,8a#,16a#,g#,2a#,8p,16a#,8d6,16d6,8d6,c6,8p,16c6,8a#,16a#,8a#,g#,8p,16g#,8g,16g,8g,16g,8f,16f,8f,16f,2d#,p,8a#,16a#,2a#,8a#,16a#,g,2a#,8a#,16a#,2a#,8a#,16a#,g#,2a#,8p,16a#,8d6,16d6,8d6,c6,8p,16c6,8a#"; //,16a#,8a#,g#";
//char *song = "Dreamingof:d=4,o=5,b=125:2e,f,e,d#,e,2f,8p,f#,g.,8p,a,b,c7,d7,c7,b,a,2g,c,d,2e,2e,e,2a,g,2c.7,c,d,2e,2e,a,8c,8b5,b5,b5,2c,f,a,2c7";
//char *song8 = "Bethlehem:d=31,o=6,b=125:8d,15p,9d,10p,6d,p,6c#,p,6d,p,6f,p,6d#,1536p,20p,22p,0p,12p,1536p,24p,21p,0p,24p,1536p,20p,21p,0p,12p,1536p,18p,23p,0p,32p,4p,8d,15p,8d,15p,8d,15p,6g,p,6f,p,6f,p,8d#,15p,6g5,1536p,18p,21p,0p,19p,p,16a5,p,16a#5,p,4";
//char *song8 = "hark:d=14,o=5,b=100:10a,19p,40a,36p,20a,20p,26g,5p,24e,15p,6f,40p,e,96p,23e,72f,30p,240p,g,19p,c,40p,3c,17p,3d,13p,1c";
//char *song = "hark:d=4,o=5,b=112:c,8p,8f,f.,8e,f,a,a,g,c6,c6,c.6,8a#,a,g,2a,c,f,f.,8e,f,a,a,g,8c6,8g,8p,g.,8p,8f,8e,8d,8p,2c,8p,c6,c6,c6,f,a#,a,a,g,c6,8p,8c6,c6,f,a#,a,a,g,d6,d6,d6,c6,a#,a,2a#,g,8a,8a#,c6,8p,8f,f.,8g,2a,d.6,8d6,d6,c6,a#,a,2a#,g,8a,8a#,c.6,8f,2f,2g,2f";
//char *song = "hark:d=4,o=5,b=112:c,8p,8f,f.,8e,f,a,a,g,c6,c6,c.6,8a#,a,g,2a,c,f,f.,8e,f,a,a,g,8c6,8g,g.,8f,8e,8d,8p,2c,c6,c6,c6,f,a#,a,a,g,c6,8c6,c6,f,a#,a,a,g,d6,d6,d6,c6,a#,a,2a#,g,8a,8a#,c6,8f,f.,8g,2a,d.6,8d6,d6,c6,a#,a,2a#,g,8a,8a#,c.6,8f,2f,2g,f.";
...
#endif
//                    (notes[(scale - 4) * 12 + note], 10)
      int ledVal = map(((notes[(scale - 4) * 12 + note])/10),50,120,0,255 );
