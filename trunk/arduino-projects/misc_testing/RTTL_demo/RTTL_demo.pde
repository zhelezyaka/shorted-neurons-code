...
char *song4 = "smbdeath:d=4,o=5,b=90:32c6,32c6,32c6,8p,16b,16f6,16p,16f6,16f.6,16e.6,16d6,16c6,16p,16e,16p,16c"; 
...
void ledWrite(int v)
{
  ...
  if (int(random(0,10)) > 4) { analogWrite(wPin, v); } else { analogWrite(wPin, 0); }
  if (int(random(0,10)) > 3) { analogWrite(rPin, v); } else { analogWrite(rPin, 0); }
  if (int(random(0,10)) > 3) { analogWrite(gPin, v); } else { analogWrite(gPin, 0); }
  if (int(random(0,10)) > 3) { analogWrite(bPin, v); } else { analogWrite(bPin, 0); }
