...
bool RFM69::initialize(byte freqBand, byte nodeID, byte networkID)
{
  ...
  SPI.setClockDivider(SPI_CLOCK_DIV16); //max speed, except on Due which can run at system clock speed
  Serial.print("about to SPI.begin... ");
  delay(100);
  SPI.begin();
  Serial.println("done");
  
  Serial.print("writeReg 1... ");
  delay(100);
  do writeReg(REG_SYNCVALUE1, 0xaa); while (readReg(REG_SYNCVALUE1) != 0xaa);
  Serial.println("done");
  Serial.print("writeReg 2... ");
  delay(100);
  ...
  for (byte i = 0; CONFIG[i][0] != 255; i++) {
     ...
     Serial.print("writeReg for loop ...  ");
     Serial.print(i);
     delay(10);
  ...
  Serial.print("setHighPower...  ");
     delay(10);
  setHighPower(_isRFM69HW); //called regardless if it's a RFM69W or RFM69HW
     Serial.println("done");
  Serial.print("setMode STANDBY...  ");
     delay(10);
  setMode(RF69_MODE_STANDBY);
     Serial.println("done");
     delay(10);
  Serial.print("wait for module to become ready...  ");
     delay(10);
