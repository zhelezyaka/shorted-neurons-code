...
//  tempLoop();
  ...
  if (temp <80 ) {
    str << "uptime=" << ts << " sec, batt=" << bv << ", i=" << iterations << ", " << temp << "F is under 80, turning the \"heater\" on\n"; 
    //digitalWrite(actLed, HIGH); 
  } else {
    str << "uptime=" << ts << " sec, batt=" << bv << ", i=" << iterations << ", " << temp << "F is >=80, turning the \"heater\" OFF\n"; 
    //digitalWrite(actLed, LOW); 
