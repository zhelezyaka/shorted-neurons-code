...
volatile long periodCount = 999999;
...
void loop() {
  ...
  if (millis() - previousMillis > oneSec) {
    ...
    nowCount = periodCount;
    periodCount = 0;    
    if (nowCount > 99999) nowCount = 00000;
    
    ltoa(nowCount,ascii,10);
//    Serial.print("periodCount is ");
